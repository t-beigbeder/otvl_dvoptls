...
push_htd_vsync() {
    ...
    cmd vdasync -source $vld -target dss://$vsh:9443/data/home/$vsu/$vdd -ca /etc/vdasync/ca_cert -clientcert /etc/vdasync/client_cert -clientkey /etc/vdasync/client_key -conc 64 $vop -rm -force
}
