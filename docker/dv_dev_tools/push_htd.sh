...
push_htd_vsync() {
    ...
    cmd vdasync $vop -source $vld -target dss://$vsh:9443/data/home/$vsu/$vdd -conc 8 -ca /etc/vdasync/ca_cert -clientcert /etc/vdasync/client_cert -clientkey /etc/vdasync/client_key
}
